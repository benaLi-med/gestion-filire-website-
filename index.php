        ...
        <ul class="navbar-nav  ">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="view/Formation IWA/objectif.html">Objectifs</a></li>
              <li><a class="dropdown-item" href="view/Formation IWA/public.html">Public visé</a></li>
              <li><a class="dropdown-item" href="view/Formation IWA/debouche.html">Débouchés de la
                  formation</a></li>
              <li><a class="dropdown-item" href="view/Formation IWA/programme.html">programme de la
                  formation</a></li>
              <li><a class="dropdown-item" href="view/Formation IWA/pre-ins.html">Pré-inscription</a>
              </li>
            </ul>
          </li>
          <li class="nav-item ">
            <a class="nav-link " href="view/event.php">Evénements</a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <li><a class="dropdown-item" href="view/espace Etudiant/profile.php">Espace étudiant</a></li>
              <li><a class="dropdown-item" href="view/espace enseignant/pf.php">Espace enseignant</a></li>
              <li><a class="dropdown-item" href="view/Admin/index.php">Espace Adminisrateur</a></li>
            </ul>
          </li>
      ...
      <div class="row">
        <div class="col-8">
          <p>
            ...
            La formation <strong> Ingénierie du Web Avancé (IWA) </strong> est préparée en concertation avec plusieurs
            sociétés nationales et multinationales pour répondre à un besoin de formation au domaine des technologies
            web les plus demandées sur le marché du travail national et international.
          </p>
          <p>
            <strong> Durée de formation:</strong> 2 ans
          </p>
          <p>
            <strong>Méthode d’enseignement:</strong> en présentiel (Faculté des Sciences de Tétouan) et à distance à
            travers des plateformes dédiées.
          </p>
          <p>
            <strong>Pour candidater à cette formation diplômante, vous êtes invité à remplir ce <a href="#">formulaire
                de pré-inscription</a> </strong> avant le 21 octobre 2022.
          </p>
          <p>
            <strong>Frais de formation: </strong> 40 000 DH pour les 2 années. Payable en 2 tranches.
          </p>
