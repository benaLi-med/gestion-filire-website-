...
if (isset($_POST['envoyer'])) {
    ...
    if (move_uploaded_file($_FILES["profileImage"]["tmp_name"], $targetFilePath)) {
        ...
        $bd = "INSERT INTO student (profileImage, CIN, CNE, Nom, Prénom, email_personnel, email_institutionnel, phone, date_de_naissance, address, diplôme ) 
               VALUES ('$fileName', '$cin', '$cne', '$nom', '$prenom', '$email_personnel', '$email_institutionnel', '$phone', '$date_de_naissance', '$address', '$diplome')";
        ...
        if ($query_run) {
            ...
            $_SESSION['message'] ='<div class="alert alert-success text-center" role="alert">
                  ...
                  header("Location: ../../view/espace etudiant/pre.php");
                  exit(0);
        } else {
